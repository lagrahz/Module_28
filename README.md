...
Папка tests содержит файлы для запуска автотестов:
test_auth_page.py - тесты для страницы авторизация;
test_registr_page.py - тесты для страницы регистрация.

Папка pages содержит следующие файлы: 
locators.py - список локаторов на страницах;
base_page.py - базовая страница, от которой унаследованы все классы;
auth_page.py - класс для страницы авторизации; 
registr_page.py - класс для страницы регистрации.
